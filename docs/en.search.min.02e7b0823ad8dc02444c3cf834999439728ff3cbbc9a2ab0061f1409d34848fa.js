...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e0a9983b9a6adf46ca8aafae8bf8665a0cb3255353a9c46261601fe6babf6913.js',function(){input.required=false;search();});}
